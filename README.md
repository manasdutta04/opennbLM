...
Teaching brains: open a notebook → **Connect brain** (live CLI/local catalogs).  
Notebooks: Home → create a notebook → add sources → grounded Chat + Studio (Audio Overview, reports, mind map, flashcards, quiz, slides — no video).  

...
The Memory screen lists teaching notes only (forget one or clear all). Notebooks stay on Home — Memory is not a second notebook list. Clear notes does not delete notebooks.
